...
AsyncResult["try"](function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
...
AsyncResult["try"](panic).onFailure(function (e /* The type of `e` is inferred as `unknown`. */) { return console.log(e.message); }); // => Panic!
AsyncResult["try"](panic, catchError).onFailure(function (e /* The type of `e` is inferred as the returned type of the function given as a second parameter. */) { return console.log(e.message); }); // => Panic!
...
function divideTenByPromise(divisor) {
    return (AsyncResult.success(undefined)
        ...
        .flatMap(function (v) {
        return AsyncResult["try"](function () { return divisor.then(function (d) { return (d === 0 ? panic() : v / d); }); }, catchError);
    }));
}
